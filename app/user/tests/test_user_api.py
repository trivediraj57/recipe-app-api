...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test error if returned is password less than 5 characters"""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': 'Test Name'
    ...
    def test_create_token_with_blank_password(self):
        """Test create token with a blank password"""
...
class PrivateUserApiTests(TestCase):
    """Test Private features of Test API"""
    ...
    def test_post_me_not_allowed(self):
        """Test POST not allowed for ME URL"""
